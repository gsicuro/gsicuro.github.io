...
function makearXiv(feed)
{
    ...
    for (x=0; x<num_entries; x++) {
	    ...
	    html+='<dd style="padding-bottom:1em;">\n\t<div class="meta" style="line-height:150%;">\n\t\t<div class="list-title" style="font-size:120%;font-weight:bold;margin:0.25em 0 0 0;line-height:120%">\n'
	    //Add the title in a span
	    html += '\t\t\t'+ feed.entries[x].title+'\n\t\t</div>';
	    //add authors in a div
	    html += '\t\t<div class="list-authors" style="font-weight:normal;font-size:100%;text-decoration:none;">'+feed.entries[x].authors+'</div>\n';
	    ...
	    if (arxiv_includeJournalRef && feed.entries[x].journal_ref && feed.entries[x].journal_ref.length > 1) {
		    html += '\t\t<div class="list-journal-ref" style="font-weight:normal;font-size:90%;"><span class="descriptor">Published in</span> ' + feed.entries[x].journal_ref + '</div>\n';
	    }
